...
public class Vietnam{
    ...
    public Vietnam(int date) throws UnsupportedEncodingException {

        List<Integer> intsToAdd = Arrays.asList(1955) ;
        ...
        if (this.hasDate(date)) {
            ...
            try {
                article = getClass()
                        .getResource("/fr/telecomnancy/anglais/data/" + Integer.toString(date) + "/vietnam.html")
                        .getPath();
            } catch (Exception e) {
            }
