...
public class SouthAfrica {
    ...
    public SouthAfrica(int date) throws UnsupportedEncodingException {

        List<Integer> intsToAdd = Arrays.asList(1994);
        ...
        if (this.hasDate(date)) {
            ...
            try {
                article = getClass()
                        .getResource("/fr/telecomnancy/anglais/data/" + Integer.toString(date) + "/southafrica.html")
                        .getPath();
            } catch (Exception e) {
            }
