...
public class Portugal {
    ...
    private final String name = "Portugal" ;
    private String article = "" ;
    private ArrayList<Integer> dates = new ArrayList<Integer>() ;

    public Portugal(int date) throws UnsupportedEncodingException {
        ...
        if (this.hasDate(date)) {
            ...
            try {
                article = getClass()
                        .getResource("/fr/telecomnancy/anglais/data/" + Integer.toString(date) + "/portugal.html")
                        .getPath();
            } catch (Exception e) {
            }
