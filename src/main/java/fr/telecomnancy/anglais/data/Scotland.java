...
public class Scotland {
    ...
    public Scotland(int date) throws UnsupportedEncodingException {

        List<Integer> intsToAdd = Arrays.asList(1320);
        ...
        if (this.hasDate(date)) {
            ...
            try {
                article = getClass()
                        .getResource("/fr/telecomnancy/anglais/data/" + Integer.toString(date) + "/scotland.html")
                        .getPath();
            } catch (Exception e) {
            }
