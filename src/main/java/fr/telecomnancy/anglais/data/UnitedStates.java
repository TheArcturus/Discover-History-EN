...
public class UnitedStates {
    ...
    public UnitedStates(int date) throws UnsupportedEncodingException {

        List<Integer> intsToAdd = Arrays.asList(1861) ;
        ...
        if (this.hasDate(date)) {
            ...
            try {
                article = getClass()
                        .getResource("/fr/telecomnancy/anglais/data/" + Integer.toString(date) + "/usa.html")
                        .getPath();
            } catch (Exception e) {
            }
